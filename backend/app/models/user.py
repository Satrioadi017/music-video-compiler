...
class User(Base):
    ...
    content_items: Mapped[list["ContentItem"]] = relationship(back_populates="user", cascade="all, delete-orphan")
    schedules: Mapped[list["Schedule"]] = relationship(back_populates="user", cascade="all, delete-orphan")
    streams: Mapped[list["LiveStream"]] = relationship(back_populates="user", cascade="all, delete-orphan")
